...
export default class App extends PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            playListInputValue: '',
            track: {
                artwork_url: 'https://i1.sndcdn.com/artworks-000166154871-r5h2yo-large.jpg',
                title: '[LEGGO Ent] EXID - L.I.E Acoustiv Ver.',
                stream_url: 'https://api.soundcloud.com/tracks/267762244/stream',
            },
            playList: [{
                artwork_url: 'https://i1.sndcdn.com/artworks-000166154871-r5h2yo-large.jpg',
                title: '[LEGGO Ent] EXID - L.I.E Acoustiv Ver.',
